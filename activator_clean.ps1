    ...
    switch ($choice) {
        "1" {
            ...
            try {
                ...
                Write-Host "[✗] Failed to run MassGrave Activation: $($_.Exception.Message)" -ForegroundColor Red
            }
        }
        "2" {
            ...
            try {
                ...
                Write-Host "[✗] Failed to run WinRAR Activation: $($_.Exception.Message)" -ForegroundColor Red
            }
        }
        "3" {
            ...
            try {
                ...
                Write-Host "[✗] Failed to run Spicetify Install: $($_.Exception.Message)" -ForegroundColor Red
            }
        }
        "4" {
            ...
            try {
                ...
                Write-Host "[✗] Failed to run Cursor Pro Install: $($_.Exception.Message)" -ForegroundColor Red
            }
        }
        "5" {
            Set-NewPassword
